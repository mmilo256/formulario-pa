    ...
    return (
        <>
            <BaseFormSection className="grid grid-cols-2" sectionName="7. Datos y Documentos Requeridos">
                <Input type="select" options={opSiNo} label="Datos, documentos y/o expedientes de otros órganos de la administración del Estado" />
                <Input type="select" options={opMediosEstado} label="Medio utilizado para obtener datos, documentos y/o expedientes de otros órganos de la administración del Estado" />
                ...
                <Input type="select" options={opMedioInterop} label="Medio utilizado para interoperar electrónicamente" />
                ...
                <Input type="select" options={opSiNo} label="Documento notarial" />
                <Input label="Nombre del documento notarial" />
                <Input type="select" options={opMedioCom} label="Medio utilizado para enviar comunicaciones oficiales entre órganos de la Administración del Estado" />
            </BaseFormSection>
